...
if __name__ == "__main__":
    ...
    Data = Import_Data('../../../2018/2018_out_new.csv')
    ...
    #train_loader = DataLoader(train_data,batch_sampler= StratifiedBatchSampler(y_train,batch_size=BATCH_SIZE))
    ...
    for pos,indices in indices_per_participant.items():
        train_sets.append(get_train(train_set,indices)) 
    device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
